...
public class View_Plan extends BorderPane{	
	...
	View_Plan(Trainee trainee){
	    Font font1 = Font.font("Verdana", FontWeight.BOLD, null, 20);
		Label Exerc = new Label("Exercise: "+trainee.getPlan().getExerc());
		Exerc.setFont(font1);
		Label Reps = new Label("Repetitions goal: "+trainee.getPlan().getReps());
		Reps.setFont(font1);
		Label Sets = new Label("Sets: "+trainee.getPlan().getSets());
		Sets.setFont(font1);
